...
// testUpdateAppointment.js

async function testUpdateAppointment() {
  const customerId = 1; // replace with the actual customer ID
  const appointmentDate = '2023-12-15'; // replace with the actual appointment date

  const url = `http://localhost:3000/appointments/${customerId}/${appointmentDate}`;

  const requestBody = {
    KHUNGGIO: '09:30:00', // replace with the new time value
    GHICHU: 'newReminder', // replace with the new reminder value
  };
...
async function testUpdateEmployee() {
  const employeeId = 1; // Thay đổi thành ID nhân viên thực tế
  const url = `http://localhost:3000/employees/${employeeId}`;

  const requestBody = {
    HOTEN: 'Nguyen Van A', // Thay đổi thành thông tin mới
    EMAIL: 'newemail@example.com', // Thay đổi thành thông tin mới
    SDT: '123456789', // Thay đổi thành thông tin mới
    GIOITINH: 'Nam', // Thay đổi thành thông tin mới
    DIACHI: '123 Street, City', // Thay đổi thành thông tin mới
    NGAYSINH: '1990-01-01', // Thay đổi thành thông tin mới
    PASSWORD: 'newpassword' // Thay đổi thành thông tin mới
  };
